<div id="vp-pfui-format-gallery-preview" class="vp-pfui-elm-block vp-pfui-elm-block-image" style="display: none;">
	<label><span><?php esc_html_e('Gallery Images', 'simple-elegant'); ?></span></label>
	<div class="vp-pfui-elm-container">
		...
		<div class="vp-pfui-gallery-picker">
			...
			<p class="none"><a href="#" class="button vp-pfui-gallery-button"><?php esc_html_e('Pick Images', 'simple-elegant'); ?></a></p>
		</div>
