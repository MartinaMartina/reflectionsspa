<div id="vp-pfui-format-quote-fields" style="display: none;">
	...
	<div class="vp-pfui-elm-block">
		<label for="vp-pfui-format-quote-source-name"><?php esc_html_e('Source Name', 'simple-elegant'); ?></label>
	...
	<div class="vp-pfui-elm-block">
		<label for="vp-pfui-format-quote-source-url"><?php esc_html_e('Source URL', 'simple-elegant'); ?></label>
