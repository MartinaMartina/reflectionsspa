 ...
 * $overlay (background)
 */
$el_class = $full_height = $full_width = $equal_height = $flex_row = $columns_placement = $content_placement = $css = $el_id = $parallax = $parallax_speed = $video_type = $video_url = $mp4 = $webm = $overlay = '';
$disable_element = '';
$output = $after_output = '';
